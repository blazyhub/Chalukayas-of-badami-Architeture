...
export const Icon: React.FC<IconProps> = ({ name, className = '', size = 6 }) => {
  ...
  const SvgIcon = (): React.ReactElement => {
    switch (name) {
      ...
      case 'mic':
        return <path strokeLinecap="round" strokeLinejoin="round" d="M12 18.75a6 6 0 006-6v-1.5a6 6 0 00-12 0v1.5a6 6 0 006 6zM12 12.75V18.75m0 0A3.75 3.75 0 0015.75 15h.375a3.75 3.75 0 000-7.5H15.75A3.75 3.75 0 0012 3.75V12.75z" />;
      case 'spinner':
          return <path d="M12,4a8,8,0,0,1,7.89,6.7A1.53,1.53,0,0,0,21.38,12h0a1.5,1.5,0,0,0,1.48-1.75,11,11,0,0,0-21.72,0A1.5,1.5,0,0,0,2.62,12h0a1.53,1.53,0,0,0,1.49-1.3A8,8,0,0,1,12,4Z" className="animate-spin origin-center"/>;
      case 'camera':
      ...
      case 'upload':
        return <path strokeLinecap="round" strokeLinejoin="round" d="M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5m-13.5-9L12 3m0 0l4.5 4.5M12 3v13.5" />;
      case 'search':
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`w-${size} h-${size} ${className}`}>
      <SvgIcon />
    </svg>
  );
};